...
const int SIDEy=32;
const int SIDEz=32;
const double M_grid=1.0*SIDEx*SIDEy; // the number of grids for the spacial division
...
const int Num_step_simple_mixing_for_WAB=20;
...
const double NXab=15.00;
const double NMu_NXab=1.0; // NMu/NXab
const double NMu=155.245690*(0.6666666)*NMu_NXab;
